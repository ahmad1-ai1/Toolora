...
export const TOOLS: ToolMetadata[] = [
  ...
  },
  {
    ...
    seoTitle: 'Free PDF Compressor — Reduce PDF File Size | Toolora',
    metaDescription: 'Reduce PDF file sizes quickly and securely in your browser. Optimize documents for email and web uploads without compromising text clarity or page layout.',
    ...
    whatIsParagraphs: [
      'A PDF compressor is a specialized document optimization utility designed to diminish the byte size of Adobe Portable Document Format (PDF) files while preserving their text crispness, vector geometries, and typographic layouts. PDFs generated by desktop office suites, vector illustration applications, or commercial high-DPI document scanners often contain uncompressed streams, redundant embedded font sets, duplicate color profiles, and excessive metadata.',
      'PDF compression works by analyzing the internal object graph of the PDF container. It compresses uncompressed content streams, restructures cross-reference tables, eliminates orphaned metadata tags, and downsamples heavy embedded raster images. This drastically slashes the resulting file size without altering the readable text layers or page pagination.',
      'Optimizing PDFs is critical for job seekers uploading resumes to applicant tracking portals, legal professionals exchanging signed contracts, and administrative teams emailing large annual reports that would otherwise bounce due to corporate email attachment quotas.',
    ],
    whyUseDetailed: [
      {
        title: 'Sensitive Document Privacy',
        description: 'Financial tax filings, legal agreements, and medical records are processed purely in local browser memory via WebAssembly and pdf-lib. No external server ever receives or reads your data.',
      },
      {
        title: 'Preserved Text and Vector Quality',
        description: 'Unlike crude rasterizers that blur text into low-resolution images, our structural stream optimization maintains selectable text, searchable strings, and sharp vector graphics.',
      },
      {
        title: 'Instant Email & Portal Compliance',
        description: 'Quickly shrink bloated multi-megabyte PDF files so they meet strict 2 MB, 5 MB, or 10 MB caps on academic, governmental, and corporate submission forms.',
      },
      {
        title: 'Completely Free with Zero Watermarks',
        description: 'Generate clean, professional PDF documents without branding overlays, forced account creation, or hidden paywalls.',
      },
    ],
    features: [
    ...
    howToSteps: [
      'Drag and drop your PDF document into the upload container or browse your device files.',
      'Review your original document details including filename, initial size, and page count.',
      'Click the "Compress PDF" button to trigger the in-browser stream optimization process.',
      'Examine the resulting file size and savings percentage, then click "Download Compressed PDF" to save the file.',
    ],
    whyUse: [
    ...
    faqs: [
      {
        question: 'Will compressing my PDF blur the text or make it unreadable?',
        answer: 'No. Toolora optimizes the underlying PDF object stream structure and eliminates redundant structural data while preserving crisp vector text and font definitions. Your text remains selectable and sharp.',
      },
      {
        question: 'Is it safe to compress confidential legal, medical, or tax PDFs?',
        answer: 'Yes, completely safe. All processing occurs strictly within your browser environment using client-side JavaScript. Your confidential files are never uploaded to any server or cloud database.',
      },
      {
        question: 'Why are some PDF files already too compressed to shrink further?',
        answer: 'PDFs that have previously been optimized or primarily consist of already-compressed JPEG scans have little redundant structural data to discard. In such cases, further reduction without degrading image resolution is minimal.',
      },
      {
        question: 'Can I compress multi-page PDF documents?',
        answer: 'Yes. Our PDF compressor seamlessly parses and optimizes multi-page documents regardless of page count, restructuring internal references across the entire document.',
      },
      {
        question: 'Are there any watermarks added to my compressed PDF?',
        answer: 'Never. Toolora is 100% free and outputs completely clean, watermark-free documents ready for professional and legal submissions.',
      },
    ],
    ...
    relatedLinks: [
      {
        slug: 'jpg-to-pdf',
        anchorText: 'JPG to PDF Converter',
        description: 'Merge multiple image files into a single, organized PDF document.',
      },
      {
        slug: 'pdf-to-jpg',
        anchorText: 'PDF to JPG Converter',
        description: 'Extract PDF pages and convert them into high-resolution JPG images.',
      },
      {
        slug: 'image-compressor',
        anchorText: 'Free Image Compressor',
        description: 'Reduce the file size of images before embedding them into documents.',
      },
    ],
  },
  {
